...
namespace RustMapEditor.Variables
{
    public static class ToolTips
    {
        ...
        public static GUIContent deleteMapPrefabs = new GUIContent("Delete All Prefabs", "Removes all the prefabs from the map.");
        public static GUIContent deleteMapPaths = new GUIContent("Delete All Paths", "Removes all the paths from the map.");
        ...
        public static GUIContent setHeightLabel = new GUIContent("Flatten");
        public static GUIContent heightToSet = new GUIContent("Height", "The height to set.");
        public static GUIContent setLandHeight = new GUIContent("Flatten Land", "Sets the terrain height to the height selected.");
        public static GUIContent setWaterHeight = new GUIContent("Flatten Water", "Sets the water height to the height selected.");
        ...
        public static GUIContent offsetLabel = new GUIContent("Nudge");
        public static GUIContent offsetHeight = new GUIContent("Y", "The height to offset.");
        ...
        public static GUIContent offsetLand = new GUIContent("Nudge land", "Adds the offset height to the terrain. Negative values lower the height.");
        public static GUIContent offsetWater = new GUIContent("Nudge Water", "Adds the offset height to the water. Negative values lower the height.");
        ...
        public static GUIContent paintLayer = new GUIContent("Fill", "Paints the active texture on the entire terrain.");
        public static GUIContent clearLayer = new GUIContent("Clear", "Paints the inactive texture on the entire terrain.");
        public static GUIContent invertLayer = new GUIContent("Invert", "Inverts the active and inactive textures over the entire terrain.");
        ...
        public static GUIContent paintAll = new GUIContent("Fill All", "Paint all Topology layers.");
    }
}